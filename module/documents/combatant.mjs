...
export default class Combatant5e extends Combatant {
  ...
  async createTurnMessage({ deltas, periods, rolls }={}) {
     ...
     * @function me5e.preCreateCombatMessage
     * @memberof hookEvents
     ...
     */
    Hooks.callAll("me5e.preCreateCombatMessage", this, messageConfig);
  ...
  async recoverCombatUses(periods) {
     ...
     * @function me5e.preCombatRecovery
     * @memberof hookEvents
     ...
     */
    if ( Hooks.call("me5e.preCombatRecovery", this, periods) === false ) return;
     ...
     */
    if ( Hooks.call("me5e.combatRecovery", this, periods, results) === false ) return;
     ...
     * @function me5e.postCombatRecovery
     * @memberof hookEvents
     * @param {Combatant5e} combatant       Combatant that is being recovered.
     * @param {string[]} periods            Periods that were recovered.
     * @param {ChatMessage5e|void} message  Chat message created, if any.
     */
    Hooks.callAll("me5e.postCombatRecovery", this, periods, message);
  }
