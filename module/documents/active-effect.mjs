...
export default class ActiveEffect5e extends ActiveEffect {
    ...
    apply(actor, change) {
        ...
        if (change.key.startsWith("flags.me5e.")) change = this._prepareFlagChange(actor, change);
    ...
    static prepareActiveEffectCategories(effects) {
        ...
        for (let e of effects) {
            if (game.me5e.isV10) e._getSourceName(); // Trigger a lookup for the source name
