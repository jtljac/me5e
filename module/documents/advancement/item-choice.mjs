...
export default class ItemChoiceAdvancement extends ItemGrantAdvancement {
    ...
    static get metadata() {
        return foundry.utils.mergeObject(super.metadata, {
            ...
            order: 50,
            icon: "systems/me5e/icons/svg/item-choice.svg",
            title: game.i18n.localize("ME5E.AdvancementItemChoiceTitle"),
            hint: game.i18n.localize("ME5E.AdvancementItemChoiceHint"),
            multiLevel: true,
            apps: {
    ...
    titleForLevel(level, {configMode = false} = {}) {
        return `${this.title} <em>(${game.i18n.localize("ME5E.AdvancementChoices")})</em>`;
    }
    ...
    _validateItemType(item, {type, restriction, strict = true} = {}) {
        ...
        if (type && (type !== item.type)) {
            ...
            if (strict) throw new Error(game.i18n.format("ME5E.AdvancementItemChoiceTypeWarning", {type: typeLabel}));
            return false;
        }
        ...
        if ((type === "feat") && restriction.type) {
            ...
            if (errorLabel) {
                if (strict) throw new Error(game.i18n.format("ME5E.AdvancementItemChoiceTypeWarning", {type: errorLabel}));
                return false;
            }
        }
        ...
        if ((type === "spell") && !Number.isNaN(l) && (item.system.level !== l)) {
            ...
            if (strict) throw new Error(game.i18n.format("ME5E.AdvancementItemChoiceSpellLevelSpecificWarning", {level}));
            return false;
        }
