  ...
  static defineSchema() {
    return {
      button: new BooleanField({
        required: true, label: "ME5E.Bastion.Button.Label", hint: "ME5E.Bastion.Button.Hint"
      }),
      duration: new NumberField({
        required: true, positive: true, integer: true, initial: 7, label: "ME5E.Bastion.Duration.Label"
      }),
      enabled: new BooleanField({
        required: true, label: "ME5E.Bastion.Enabled.Label", hint: "ME5E.Bastion.Enabled.Hint"
      })
    };
  }
}
