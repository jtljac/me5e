 ...
 * @property {string} actionType          Action type as defined in `ME5E.itemActionTypes`.
    ...
    static defineSchema() {
        return {
            ability: new foundry.data.fields.StringField({
                required: true, nullable: true, initial: null, label: "ME5E.AbilityModifier"
            }),
            actionType: new foundry.data.fields.StringField({
                required: true, nullable: true, initial: null, label: "ME5E.ItemActionType"
            }),
            attackBonus: new FormulaField({required: true, label: "ME5E.ItemAttackBonus"}),
            ...
            critical: new foundry.data.fields.SchemaField({
                threshold: new foundry.data.fields.NumberField({
                    required: true, integer: true, initial: null, positive: true, label: "ME5E.ItemCritThreshold"
                }),
                damage: new FormulaField({required: true, label: "ME5E.ItemCritExtraDamage"})
            }),
            damage: new foundry.data.fields.SchemaField({
                ...
                versatile: new FormulaField({required: true, label: "ME5E.VersatileDamage"})
            }, {label: "ME5E.Damage"}),
            formula: new FormulaField({required: true, label: "ME5E.OtherFormula"}),
            save: new foundry.data.fields.SchemaField({
                ability: new foundry.data.fields.StringField({required: true, blank: true, label: "ME5E.Ability"}),
                dc: new foundry.data.fields.NumberField({
                    required: true, min: 0, integer: true, label: "ME5E.AbbreviationDC"
                }),
                scaling: new foundry.data.fields.StringField({
                    required: true, blank: false, initial: "spell", label: "ME5E.ScalingFormula"
                })
            }, {label: "ME5E.SavingThrow"})
        };
    }
