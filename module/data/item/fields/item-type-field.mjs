  ...
  constructor(options={}, schemaOptions={}) {
    const fields = {
      value: new StringField({
        required: true, blank: true, initial: options.value ?? "", label: "ME5E.Type"
      }),
      subtype: new StringField({
        required: true, blank: true, initial: options.subtype ?? "", label: "ME5E.Subtype"
      }),
      baseItem: new StringField({
        required: true, blank: true, initial: options.baseItem ?? "", label: "ME5E.BaseItem"
      })
    };
