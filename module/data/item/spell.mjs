 ...
 * @property {string} preparation.mode           Spell preparation mode as defined in `ME5E.spellPreparationModes`.
 ...
 * @property {string} scaling.mode               Spell scaling mode as defined in `ME5E.spellScalingModes`.
