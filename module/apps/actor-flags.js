...
export default class ActorSheetFlags extends DocumentSheet {
    ...
    _getBonuses() {
        const bonuses = [
            ...
            {name: "data.bonuses.mpak.attack", label: "ME5E.BonusMSAttack"},
            {name: "data.bonuses.mpak.damage", label: "ME5E.BonusMSDamage"},
            {name: "data.bonuses.rpak.attack", label: "ME5E.BonusRSAttack"},
            {name: "data.bonuses.rpak.damage", label: "ME5E.BonusRSDamage"},
