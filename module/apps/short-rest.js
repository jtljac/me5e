...
export default class ShortRestDialog extends Dialog {
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      template: "systems/me5e/templates/apps/short-rest.html",
      classes: ["me5e", "dialog"]
    });
  }
  ...
  getData() {
    ...
    // Determine rest type
    const variant = game.settings.get("me5e", "restVariant");
  ...
  static async shortRestDialog({ actor }={}) {
    return new Promise((resolve, reject) => {
      const dlg = new this(actor, {
        title: `${game.i18n.localize("ME5E.ShortRest")}: ${actor.name}`,
        buttons: {
          rest: {
