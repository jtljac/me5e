...
export default class DamageRoll extends Roll {
     ...
     * @type {string}
     */
    static EVALUATION_TEMPLATE = "systems/me5e/templates/chat/roll-dialog.hbs";
    ...
    configureDamage() {
        ...
        if (this.options.powerfulCritical && (flatBonus > 0)) {
            ...
            this.terms.push(new NumericTerm({number: flatBonus}, {flavor: game.i18n.localize("ME5E.PowerfulCritical")}));
        }
    ...
    toMessage(messageData = {}, options = {}) {
        ...
        if (this.isCritical) {
            const label = game.i18n.localize("ME5E.CriticalHit");
            ...
            new Dialog({
                ...
                buttons: {
                    critical: {
                        ...
                        label: game.i18n.localize("ME5E.CriticalHit"),
                        callback: html => resolve(this._onDialogSubmit(html, true))
                    },
                    normal: {
                        label: game.i18n.localize(allowCritical ? "ME5E.Normal" : "ME5E.Roll"),
