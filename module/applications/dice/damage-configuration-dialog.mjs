...
export default class DamageRollConfigurationDialog extends RollConfigurationDialog {
  ...
  static PARTS = {
    ...super.PARTS,
    formulas: {
      template: "systems/me5e/templates/dice/damage-formulas.hbs"
    }
  };
  ...
  async _prepareFormulasContext(context, options) {
    ...
    const allTypes = foundry.utils.mergeObject(CONFIG.ME5E.damageTypes, CONFIG.ME5E.healingTypes, { inplace: false });
