...
export default class CopyableTextElement extends (foundry.applications.elements.AdoptableHTMLElement ?? HTMLElement) {
  ...
  connectedCallback() {
    ...
    button.ariaLabel = this.getAttribute("label") ?? game.i18n.localize("ME5E.Copy");
  ...
  _onClick(event) {
    ...
    game.tooltip.activate(event.target, { text: game.i18n.format("ME5E.Copied", { value }), direction: "UP" });
  }
}
