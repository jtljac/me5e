...
export default class ActorHitPointsConfig extends BaseConfigSheet {
    ...
    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            classes: ["me5e", "actor-hit-points-config"],
            template: "systems/me5e/templates/apps/hit-points-config.hbs",
            width: 320,
            height: "auto",
            sheetConfig: false
        });
    ...
    /** @inheritdoc */
    get title() {
        return `${game.i18n.localize("ME5E.HitPointsConfig")}: ${this.document.name}`;
    }
    ...
    async _onRollHPFormula(event) {
        ...
        try {
            ...
            ui.notifications.error(game.i18n.localize("ME5E.HPFormulaError"));
            throw error;
        }
    }
}
