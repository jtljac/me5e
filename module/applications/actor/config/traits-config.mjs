...
export default class TraitsConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    traits: {
      template: "systems/me5e/templates/actors/config/traits-config.hbs"
    }
  };
   ...
   */
  get otherLabel() {
    return game.i18n.localize("ME5E.ProficiencyOther");
  }
  ...
  _initializeApplicationOptions(options) {
    ...
    if ( !CONFIG.ME5E.traits[options.trait] ) throw new Error(
      `Cannot instantiate TraitsConfig with a trait not defined in CONFIG.ME5E.traits: ${options.trait}.`
    );
  ...
  _processFormData(event, form, formData) {
    ...
    if ( !CONFIG.ME5E.traits[this.options.trait].dataType ) {
