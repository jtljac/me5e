...
export default class HabitatConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    config: {
      template: "systems/me5e/templates/actors/config/habitat-config.hbs"
    }
  };
  ...
  /** @override */
  get title() {
    return game.i18n.localize("ME5E.Habitat.Configuration.Title");
  }
  ...
  async _prepareContext(options) {
    ...
    const config = CONFIG.ME5E.habitats;
