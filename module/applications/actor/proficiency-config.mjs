...
export default class ProficiencyConfig extends BaseConfigSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["me5e"],
      template: "systems/me5e/templates/apps/proficiency-config.hbs",
      width: 500,
      height: "auto"
    });
  }
  ...
  /** @inheritdoc */
  get title() {
    const label = this.isSkill ? CONFIG.ME5E.skills[this.options.key].label : Trait.keyLabel("tool", this.options.key);
    return `${game.i18n.format("ME5E.ProficiencyConfigureTitle", {label})}: ${this.document.name}`;
  }
