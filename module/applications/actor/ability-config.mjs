...
export default class ActorAbilityConfig extends BaseConfigSheet {
  ...
  /** @override */
  get title() {
    return `${game.i18n.format("ME5E.AbilityConfigureTitle", {
      ability: CONFIG.ME5E.abilities[this._abilityId].label})}: ${this.document.name}`;
  }
  ...
  getData(options) {
    ...
    const ability = CONFIG.ME5E.abilities[this._abilityId].label;
    return {
      ability: src.system.abilities[this._abilityId] ?? this.document.system.abilities[this._abilityId] ?? {},
      labelSaves: game.i18n.format("ME5E.AbilitySaveConfigure", {ability}),
      labelChecks: game.i18n.format("ME5E.AbilityCheckConfigure", {ability}),
