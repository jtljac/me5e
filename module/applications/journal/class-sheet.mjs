...
export default class JournalClassPageSheet extends JournalPageSheet {
    ...
    /** @inheritdoc */
    get template() {
        return `systems/me5e/templates/journal/page-class-${this.isEditable ? "edit" : "view"}.hbs`;
    }
            ...
            for (const advancement of item.advancement.byLevel[level]) {
                switch (advancement.constructor.typeName) {
                    case "AbilityScoreImprovement":
                        features.push(game.i18n.localize("ME5E.AdvancementAbilityScoreImprovementTitle"));
                        continue;
                    case "ItemGrant":
    ...
    async _getSpellProgression(item) {
        ...
        if (spellcasting.type === "leveled") {
            ...
            table.headers = [
                [{
                    content: game.i18n.localize("JOURNALENTRYPAGE.ME5E.Class.SpellSlotsPerSpellLevel"),
                    colSpan: largestSlot
                }],
             ...
             */
            Hooks.callAll(
                `me5e.build${spellcasting.type.capitalize()}SpellcastingTable`, table, item, spellcasting
            );
        }
