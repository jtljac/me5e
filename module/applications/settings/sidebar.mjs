...
function _generateLinks() {
  ...
  links.innerHTML = `
    <li>
      <a href="https://github.com/foundryvtt/me5e/releases/latest" target="_blank">
        ${game.i18n.localize("ME5E.Notes")}
      </a>
    </li>
    <li>
      <a href="https://github.com/foundryvtt/me5e/issues" target="_blank">${game.i18n.localize("ME5E.Issues")}</a>
    </li>
    <li>
      <a href="https://github.com/foundryvtt/me5e/wiki" target="_blank">${game.i18n.localize("ME5E.Wiki")}</a>
    </li>
    <li>
      <a href="https://discord.com/channels/170995199584108546/670336046164213761" target="_blank">
        ${game.i18n.localize("ME5E.Discord")}
      </a>
    </li>
  `;
  return links;
...
export function renderSettings(html) {
  ...
  section.classList.add("me5e2", "sidebar-info");
  section.innerHTML = `
    <h4 class="divider">${game.i18n.localize("WORLD.FIELDS.system.label")}</h4>
    <div class="system-badge">
      <img src="systems/me5e/ui/official/dnd-badge-32.webp" data-tooltip="${me5e.title}" alt="${me5e.title}">
      <span class="system-info">${me5e.version}</span>
    </div>
  `;
