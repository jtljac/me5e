...
Object.defineProperty(ME5E, "abilityAbbreviations", {
    get() {
        foundry.utils.logCompatibilityWarning(
            "The `abilityAbbreviations` configuration object has been merged with `abilities`.",
            {since: "ME5e 2.2", until: "ME5e 2.4"}
        );
        return Object.fromEntries(Object.entries(ME5E.abilities).map(([k, v]) => [k, v.abbreviation]));
    }
});
 ...
 * starting equipment provided by classes and backgrounds.
 * @enum {string}
 * TODO: See about reimplementing this
 */
ME5E.toolIds = {};
...
ME5E.traits = {
    saves: {
        label: "ME5E.ClassSaves",
        configKey: "abilities",
        labelKey: "label"
    },
    skills: {
        label: "ME5E.TraitSkillProf",
        labelKey: "label"
    },
    di: {
        label: "ME5E.DamImm",
