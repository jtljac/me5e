...
export class ModuleArt {
    ...
    async registerModuleArt() {
        ...
        for (const module of game.modules) {
            ...
            try {
                ...
                await this.#parseArtMapping(module.id, mapping, flags["me5e-art-credit"]);
            } catch(e) {
                console.error(e);
            }
        }
    ...
    async #parseArtMapping(moduleId, mapping, credit) {
        let settings = game.settings.get("me5e", "moduleArtConfiguration")?.[moduleId];
...
export class ModuleArtConfig extends FormApplication {
    ...
    constructor(object = {}, options = {}) {
        object = foundry.utils.mergeObject(game.settings.get("me5e", "moduleArtConfiguration"), object, {inplace: false});
    ...
    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            title: game.i18n.localize("ME5E.ModuleArtConfigL"),
            id: "module-art-config",
            template: "systems/me5e/templates/apps/module-art-config.html",
            popOut: true,
            width: 600,
            height: "auto"
        });
    ...
    getData(options = {}) {
        ...
        context.config.unshift({label: game.system.title, id: game.system.id, ...this.object.me5e});
        return context;
    }
    ...
    async _updateObject(event, formData) {
        await game.settings.set("me5e", "moduleArtConfiguration", foundry.utils.expandObject(formData));
